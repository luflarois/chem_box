 ...
 CONTAINS
   SUBROUTINE kinetic(jppj,Jphoto,rk,temp,xlw,Press,ijkbeg,ijkend,maxblock_size,nr)
...
!------------------------------------------------------------------------
      ...
      DOUBLE PRECISION,INTENT(IN) ::  xlw(maxblock_size)
...
!     For the zenithal angle at tropics
     ...
     !  DO ijk=ijkbeg,ijkend
      ...
      Rapk(ijkbeg:ijkend) =  0.4700000000000000D-11* (temp(ijkbeg:ijkend) / 3.d2)   &
                    **(- ( 0.1400000000000000D+01))
      facteur(ijkbeg:ijkend) = (Effko(ijkbeg:ijkend) * SumM(ijkbeg:ijkend) / ( 1.0d0 + Effko(ijkbeg:ijkend) &
                 * SumM(ijkbeg:ijkend) /    &
      ...
      rk(ijkbeg:ijkend, 40) = Effko(ijkbeg:ijkend) + facteur(ijkbeg:ijkend)/(1.0d0 + facteur(ijkbeg:ijkend) &
                              / Rapk(ijkbeg:ijkend))
